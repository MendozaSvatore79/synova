      ...
      <div className={styles.container}>
        ...
        <Link href="/" className={styles.logo} onClick={closeMobileMenu}>
          ...
          <div className={styles.logoTextWrapper}>
            <span className={styles.logoText}>SYNOVA</span>
            <span className={styles.logoSubtext}>SYSTEMS</span>
          </div>
        </Link>
        ...
        <ul className={`${styles.navLinks} ${mobileMenuOpen ? styles.mobileOpen : ""}`}>
              ...
              <div className={styles.dropdownContent}>
                <div className={styles.dropdownSection}>
                  ...
                  <Link href="/services/web-development" className={styles.dropdownItem} onClick={closeMobileMenu}>
                    ...
                    <div>
                      <span className={styles.dropdownItemTitle}>Web Development</span>
                      <span className={styles.dropdownItemDesc}>Custom websites & web apps</span>
                    </div>
                  </Link>
                  <Link href="/services/mobile-development" className={styles.dropdownItem} onClick={closeMobileMenu}>
                    ...
                    <div>
                      <span className={styles.dropdownItemTitle}>Mobile Development</span>
                      <span className={styles.dropdownItemDesc}>iOS & Android apps</span>
                    </div>
                  </Link>
                  <Link href="/services/api-development" className={styles.dropdownItem} onClick={closeMobileMenu}>
                    ...
                    <div>
                      <span className={styles.dropdownItemTitle}>API Development</span>
                      <span className={styles.dropdownItemDesc}>RESTful & GraphQL APIs</span>
                    </div>
                  </Link>
                </div>
                <div className={styles.dropdownSection}>
                  ...
                  <Link href="/services/ui-ux-design" className={styles.dropdownItem} onClick={closeMobileMenu}>
                    ...
                    <div>
                      <span className={styles.dropdownItemTitle}>UI/UX Design</span>
                      <span className={styles.dropdownItemDesc}>Beautiful user experiences</span>
                    </div>
                  </Link>
                  <Link href="/services/consulting" className={styles.dropdownItem} onClick={closeMobileMenu}>
                    ...
                    <div>
                      <span className={styles.dropdownItemTitle}>Consulting</span>
                      <span className={styles.dropdownItemDesc}>Technical strategy & advice</span>
                    </div>
                  </Link>
                </div>
              </div>
          ...
          >
            ...
            >
              <span className={styles.linkText}>Solutions</span>
            ...
            <div className={`${styles.dropdown} ${activeDropdown === "solutions" ? styles.active : ""}`}>
              <div className={styles.dropdownContent}>
                <Link href="/solutions/enterprise" className={styles.dropdownItem} onClick={closeMobileMenu}>
                  ...
                  <div>
                    <span className={styles.dropdownItemTitle}>Enterprise Solutions</span>
                    <span className={styles.dropdownItemDesc}>Scalable enterprise systems</span>
                  </div>
                </Link>
                <Link href="/solutions/startups" className={styles.dropdownItem} onClick={closeMobileMenu}>
                  ...
                  <div>
                    <span className={styles.dropdownItemTitle}>Startups & MVPs</span>
                    <span className={styles.dropdownItemDesc}>Rapid product development</span>
                  </div>
                </Link>
                <Link href="/solutions/ecommerce" className={styles.dropdownItem} onClick={closeMobileMenu}>
                  ...
                  <div>
                    <span className={styles.dropdownItemTitle}>E-commerce</span>
                    <span className={styles.dropdownItemDesc}>Online stores & marketplaces</span>
                  </div>
                </Link>
              </div>
            </div>
          ...
          <li>
            <Link href="/case-studies" className={styles.navLink} onClick={closeMobileMenu}>
              <span className={styles.linkText}>Case studies</span>
              <span className={styles.linkUnderline}></span>
            </Link>
          </li>
            ...
            <div className={`${styles.dropdown} ${activeDropdown === "resources" ? styles.active : ""}`}>
              <div className={styles.dropdownContent}>
                <Link href="/blog" className={styles.dropdownItem} onClick={closeMobileMenu}>
                  ...
                  <div>
                    <span className={styles.dropdownItemTitle}>Blog</span>
                    <span className={styles.dropdownItemDesc}>Articles & insights</span>
                  </div>
                </Link>
                <Link href="/resources/documentation" className={styles.dropdownItem} onClick={closeMobileMenu}>
                  ...
                  <div>
                    ...
                    <span className={styles.dropdownItemDesc}>Technical guides</span>
                  </div>
                </Link>
                <Link href="/resources/whitepaper" className={styles.dropdownItem} onClick={closeMobileMenu}>
                  ...
                  <div>
                    <span className={styles.dropdownItemTitle}>Whitepapers</span>
                    <span className={styles.dropdownItemDesc}>In-depth research</span>
                  </div>
                </Link>
              </div>
            </div>
